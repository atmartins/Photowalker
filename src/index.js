...
const suggestedMongoCmd = 'docker run --name mongo -p 27017:27017 -d mongo:latest';
...
async function main() {
    ...
    try {
        ...
        err(`Couldn't connect to ${connectionString}. Perhaps you need to run "${suggestedMongoCmd}"?`);
        exit();
    }
